        ...
        <div className="grid gap-8 grid-cols-1 lg:grid-cols-3 w-full">
          ...
          <div className="flex flex-col gap-8">
            ...
            <ContactCard
              ...
              text="kathirbhavamkm@gmail.com"
              btnText="Email me"
            />
          </div>
          <div className="lg:col-span-2 bg-secondary-background border border-border rounded-lg space-y-6 relative overflow-hidden py-5 px-[25px] shadow-md w-[600px] px-18">
            <ContactCard
              title="See My works here"
              icon={<MdSubject className="fill-[#333] text-lg" />}
              text="https://drive.google.com/drive/folders/16UjlN93hK4hOHubXfWX0v46L9_-CJ9Dt"
              btnText="Works"
            />
          </div>
