...
const socials = [
  ...
  // },
  {
    ...
    link: "https://www.linkedin.com/in/kathiravan-t-7aa311251?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    username: "Kathiravan T",
  },
  {
    icon: <FaInstagram className="w-5 h-5" />,
    link: "https://www.instagram.com/rtx_editzz?igsh=eWs4MGptdnBqcmhw&utm_source=qr",
    username: "RTX_EDITZZ",
  },
];
